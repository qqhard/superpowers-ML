...
**1. Finish** — Effective subtasks are ready. Invoke `superpowers-ml:finishing-a-development-branch` to wrap up.

**2. Add subtasks** — Continue this experiment with additional subtasks. I'll add them to the existing plan.

**3. New brainstorm** — Start a new experiment direction. Invoke `superpowers-ml:ml-brainstorming`."
...
- **superpowers-ml:ml-subagent-dev** — Produces the subtask results this skill verifies
- **superpowers-ml:validation-pyramid** — VP checks referenced in verification
- **superpowers-ml:ml-brainstorming** — Next step if new experiment needed
- **superpowers-ml:finishing-a-development-branch** — Next step if experiment is done
