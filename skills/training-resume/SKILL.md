...
4. Invoke `spml:training-handoff` to generate new artifacts
...
3. Invoke `spml:training-handoff` with updated training config
...
2. Invoke `spml:data-preparation` to fix and re-validate data
